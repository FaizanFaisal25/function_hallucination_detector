...
'''
"""Intern project preference questionnaire (Summer 2026): US Data Scientist - Product
Thank you for your interest in Google's Data Scientist - Product Intern Role! If you’ve received this form we have received your application and are proceeding to initial steps for consideration. We are having the hiring team review over the next several weeks (potentially months) before we can confirm if we will be moving to interviews. If you do not hear from a recruiter, this means the hiring team has yet to select your application, but it is still in review. If selected for interviews, a recruiter will reach out and walk you through next steps and expected timeline at that time. Thank you for your patience!

If this reaches you and you've already accepted a Summer 2026 internship, please disregard and do not complete the form.

THIS FORM IS IMPORTANT! Google will use your answers to match your background, skills, interests and preferences with our projects. Potential hosts will see your answers exactly as you provide them, and make decisions based on them, so do take the time to do this well.  Help Google find the best fit for you.

Google's use of this data is governed by our privacy policy found at https://careers.google.com/privacy-policy/"""


"""Tips
1. Be thorough. The more information you supply, and the more accurately it reflects your abilities and interests, the more likely we will be able to match you with a fulfilling and enjoyable project.

2. Be concise. Short summaries are better than essays. Highlight your relevant experience and skills, but don't just cut and paste from your resume.

3. Do answer the open-ended questions. You are more likely to get hired if you do."""



"""Disciplines with existing skills/experience
*
Which of these disciplines are you proficient in? Select up to 5.
Applied knowledge of measurement
AutoFX
...
Which areas would get me best chance at the Job?


"""Join Google as a Data Scientist Intern to provide quantitative analysis and strategic insights that drive product decisions.

Your Role

Here’s what you will be doing:

Conduct data analysis to make business or product recommendations including cost-benefit, invest-divest, forecasting, and impact analysis.
...
Collaborate with cross-functional stakeholders to understand their business needs, formulate and complete analysis that includes data gathering, analysis, ongoing scaled deliverables, and presentations.
Help Google focus on key decisions to improve products and services.
About You

The company is looking for:

Currently pursuing a Master's degree in a quantitative field (e.g., Statistics, Computer Science, Engineering, Mathematics, Data Sciences, etc.).
...
Interest and ability to work with data, metrics, analysis and trends and applied knowledge of measurement, statistics and program evaluation.
Excellent problem-solving and written/verbal communication skills, with excellent business judgment.
English proficiency is required.
Must be located in the United States for the duration of the internship program.
Compensation

US base salary range: $90,000 - $120,000 for this full-time position.
How to Apply

Prepare an updated CV or resume listing your anticipated graduation date (MM/YY).
Attach a current or recent unofficial or official transcript in English.
In the application, upload your resume in the “Resume Section” and your transcript in the “Education Section” selecting “Now attending” under “Degree Status.”""""'''